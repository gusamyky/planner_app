...
const EventSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'timeFrom': PropertySchema(
      id: 3,
      name: r'timeFrom',
      type: IsarType.dateTime,
    ),
    r'timeTo': PropertySchema(
      id: 4,
      name: r'timeTo',
      type: IsarType.dateTime,
    ),
...
void _eventSerialize(
  ...
  writer.writeDateTime(offsets[3], object.timeFrom);
  writer.writeDateTime(offsets[4], object.timeTo);
...
Event _eventDeserialize(
  ...
  final object = Event(
    ...
    status: _EventstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
        EventStatus.todo,
    timeFrom: reader.readDateTimeOrNull(offsets[3]),
    timeTo: reader.readDateTimeOrNull(offsets[4]),
...
extension EventQueryFilter on QueryBuilder<Event, Event, QFilterCondition> {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeFromIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'timeFrom',
      ));
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeFromIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'timeFrom',
      ));
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeFromEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'timeFrom',
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeFromGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeFromLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeFromBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeToIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'timeTo',
      ));
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeToIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'timeTo',
      ));
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeToEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'timeTo',
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeToGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeToLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeToBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension EventQuerySortBy on QueryBuilder<Event, Event, QSortBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> sortByTimeFrom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeFrom', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByTimeFromDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeFrom', Sort.desc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByTimeTo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeTo', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByTimeToDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeTo', Sort.desc);
    });
  }
...
extension EventQuerySortThenBy on QueryBuilder<Event, Event, QSortThenBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> thenByTimeFrom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeFrom', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByTimeFromDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeFrom', Sort.desc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByTimeTo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeTo', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByTimeToDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeTo', Sort.desc);
    });
  }
...
extension EventQueryWhereDistinct on QueryBuilder<Event, Event, QDistinct> {
  ...
  QueryBuilder<Event, Event, QDistinct> distinctByTimeFrom() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'timeFrom');
    });
  }

  QueryBuilder<Event, Event, QDistinct> distinctByTimeTo() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'timeTo');
    });
  }
...
extension EventQueryProperty on QueryBuilder<Event, Event, QQueryProperty> {
  ...
  QueryBuilder<Event, DateTime?, QQueryOperations> timeFromProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'timeFrom');
    });
  }

  QueryBuilder<Event, DateTime?, QQueryOperations> timeToProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'timeTo');
    });
  }
